...
class AutoEncoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.Conv2d(8, 3, 3, stride=2, padding=1),  # b, 8, 256, 256
            nn.InstanceNorm2d(3),
            nn.LeakyReLU(0.2, inplace=True),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(3, 8, 4, stride=2, padding=1),  # b, 8, 128, 128
            nn.LeakyReLU(0.2, inplace=True),
            nn.Upsample(scale_factor = 2,mode = "bilinear"),# b, 8, 256, 256
