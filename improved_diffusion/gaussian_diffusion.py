...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, t, context=None, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
    ...
    def training_losses(self, model, x_start, t, context=None, model_kwargs=None, noise=None):
        """
